...
Companion to `naming-audit.md` (auto-generated by `scripts/naming_audit.py`).
Tracks yait #15 / #16 / #68.

> Acceptance per #15: `docs/naming-audit.md` exists with old→new mapping.
> This file is the human-curated rename plan. Re-run the script to refresh
> the raw audit; this proposal is hand-checked.
